...
Four plain HTML pages that share one design and a sticky tab bar at the top, so a reader can move between them with one tap:
...
The tab bar appears on all four pages, in the order Hub, Examples, The briefing, The op-ed. The hub is the default; the others are one tap away, and each page also links to the rest from its footer.
